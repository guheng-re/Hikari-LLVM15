...
entry:
  ...
  %prod = extractvalue { i32, i1 } %pair, 0
  %ov = extractvalue { i32, i1 } %pair, 1
  %ov.z = zext i1 %ov to i32
  %result = xor i32 %prod, %ov.z
  ret i32 %result
}
...
entry:
  ; No overflow: 6*7
  %e0 = call i32 @reference(i32 6, i32 7)
  %a0 = call i32 @protected(i32 6, i32 7)
  ; Unsigned overflow: UINT_MAX * 2
  %e1 = call i32 @reference(i32 4294967295, i32 2)
  %a1 = call i32 @protected(i32 4294967295, i32 2)
