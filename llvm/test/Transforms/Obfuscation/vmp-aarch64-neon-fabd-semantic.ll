; Restricted AArch64 NEON floating absolute difference via
...
;     plus HasFullFP16:
;       <4 x half> / <8 x half>
; Clang vabd float forms.  Must not lower to fabs(fsub).
; Well-formed sisd.fabd is
; vmp-aarch64-neon-sisd-fabd-semantic.ll and must not stay here
; as a skip (it would virtualize).  v1f64 stays out.
...
; No last-token gate for f32/f64.  No new opcode.
;
...
declare <2 x half> @llvm.aarch64.neon.fabd.v2f16(<2 x half>, <2 x half>)
declare <4 x bfloat> @llvm.aarch64.neon.fabd.v4bf16(<4 x bfloat>, <4 x bfloat>)
...
define <2 x float> @protected_fabd_v2f32(<2 x float> %a, <2 x float> %b) noinline optnone {
entry:
  call void @hikari_vmp()
  %r = call <2 x float> @llvm.aarch64.neon.fabd.v2f32(<2 x float> %a, <2 x float> %b)
  ret <2 x float> %r
}

define <4 x float> @protected_fabd_v4f32(<4 x float> %a, <4 x float> %b) noinline optnone {
entry:
  call void @hikari_vmp()
  %r = call <4 x float> @llvm.aarch64.neon.fabd.v4f32(<4 x float> %a, <4 x float> %b)
  ret <4 x float> %r
}

define <2 x double> @protected_fabd_v2f64(<2 x double> %a, <2 x double> %b) noinline optnone {
entry:
  call void @hikari_vmp()
  %r = call <2 x double> @llvm.aarch64.neon.fabd.v2f64(<2 x double> %a, <2 x double> %b)
  ret <2 x double> %r
}

define <4 x half> @protected_fabd_v4f16(<4 x half> %a, <4 x half> %b) noinline optnone "target-features"="+fullfp16" {
entry:
  call void @hikari_vmp()
  %r = call <4 x half> @llvm.aarch64.neon.fabd.v4f16(<4 x half> %a, <4 x half> %b)
  ret <4 x half> %r
}

define <8 x half> @protected_fabd_v8f16(<8 x half> %a, <8 x half> %b) noinline optnone "target-features"="+fullfp16" {
entry:
  call void @hikari_vmp()
  %r = call <8 x half> @llvm.aarch64.neon.fabd.v8f16(<8 x half> %a, <8 x half> %b)
  ret <8 x half> %r
}

define <4 x half> @protected_fabd_last_fullfp16(<4 x half> %a, <4 x half> %b) noinline optnone "target-features"="+neon,+fp16fml,+fullfp16" {
entry:
  call void @hikari_vmp()
  %r = call <4 x half> @llvm.aarch64.neon.fabd.v4f16(<4 x half> %a, <4 x half> %b)
  ret <4 x half> %r
...
entry:
  call void @hikari_vmp()
  %r = call nnan ninf <2 x float> @llvm.aarch64.neon.fabd.v2f32(<2 x float> %a, <2 x float> %b)
  ret <2 x float> %r
}

; Signed-zero / NaN / Inf boundaries.
define <4 x float> @protected_fabd_bounds_v4f32() noinline optnone {
entry:
  call void @hikari_vmp()
  %r = call <4 x float> @llvm.aarch64.neon.fabd.v4f32(
      <4 x float> <float -0.0, float 0x7FF8000000000000, float 0x7FF0000000000000, float 0xFFF0000000000000>,
      <4 x float> <float 0.0, float 1.0, float 0.0, float 0.0>)
  ret <4 x float> %r
}

; Well-formed llvm.aarch64.neon.sabd is covered by
; vmp-aarch64-neon-abd-semantic.ll.  Generic fabs/fsub already
; virtualize as float-vector arithmetic.  Well-formed sisd.fabd
; is vmp-aarch64-neon-sisd-fabd-semantic.ll.

define <1 x double> @unsupported_v1f64(<1 x double> %a, <1 x double> %b) noinline optnone {
entry:
  call void @hikari_vmp()
  %r = call <1 x double> @llvm.aarch64.neon.fabd.v1f64(<1 x double> %a, <1 x double> %b)
  ret <1 x double> %r
}
...
entry:
  call void @hikari_vmp()
  %r = call <2 x half> @llvm.aarch64.neon.fabd.v2f16(<2 x half> %a, <2 x half> %b)
  ret <2 x half> %r
}
...
entry:
  call void @hikari_vmp()
  %r = call <4 x bfloat> @llvm.aarch64.neon.fabd.v4bf16(<4 x bfloat> %a, <4 x bfloat> %b)
  ret <4 x bfloat> %r
}
...
define <vscale x 4 x float> @unsupported_sve_fabd(<vscale x 4 x i1> %pg, <vscale x 4 x float> %a, <vscale x 4 x float> %b) noinline optnone {
entry:
  call void @hikari_vmp()
  %r = call <vscale x 4 x float> @llvm.aarch64.sve.fabd.nxv4f32(<vscale x 4 x i1> %pg, <vscale x 4 x float> %a, <vscale x 4 x float> %b)
...
entry:
  call void @hikari_vmp()
  %r = call fastcc <2 x float> @llvm.aarch64.neon.fabd.v2f32(<2 x float> %a, <2 x float> %b)
  ret <2 x float> %r
}
...
entry:
  call void @hikari_vmp()
  %r = musttail call <2 x float> @llvm.aarch64.neon.fabd.v2f32(<2 x float> %a, <2 x float> %b)
  ret <2 x float> %r
}
...
entry:
  call void @hikari_vmp()
  %r = call <2 x float> @llvm.aarch64.neon.fabd.v2f32(<2 x float> %a, <2 x float> %b) [ "deopt"(i32 0) ]
  ret <2 x float> %r
}
...
entry:
  call void @hikari_vmp()
  %r = call <2 x float> @llvm.aarch64.neon.fabd.v2f32(<2 x float> %a, <2 x float> %b) noreturn
  ret <2 x float> %r
}
...
entry:
  call void @hikari_vmp()
  %r = call <2 x float> @llvm.aarch64.neon.fabd.v2f32(<2 x float> %a, <2 x float> %b) returns_twice
  ret <2 x float> %r
}
...
entry:
  ...
  %r0 = call <2 x float> @protected_fabd_v2f32(<2 x float> %a2, <2 x float> %b2)
  ...
  %r1 = call <4 x float> @protected_fabd_v4f32(<4 x float> %a4, <4 x float> %b4)
  ...
  %r2 = call <2 x double> @protected_fabd_v2f64(<2 x double> %ad, <2 x double> %bd)
  ...
  %r3 = call <4 x half> @protected_fabd_v4f16(<4 x half> %h4a, <4 x half> %h4b)
  ...
  %r4 = call <8 x half> @protected_fabd_v8f16(<8 x half> %h8a, <8 x half> %h8b)
  store volatile <8 x half> %r4, ptr @sink_v8f16, align 16
  %r5 = call <4 x half> @protected_fabd_last_fullfp16(<4 x half> %h4a, <4 x half> %h4b)
  store volatile <4 x half> %r5, ptr @sink_v4f16, align 8
  %r7 = call <4 x float> @protected_fabd_bounds_v4f32()
...
; SKIP-DAG: Skipping VMP on unsupported_sve_fabd: unsupported return type
...
; SKIP-NOT: Skipping VMP on protected_fabd_v2f32:
; SKIP-NOT: Skipping VMP on protected_fabd_v4f32:
; SKIP-NOT: Skipping VMP on protected_fabd_v2f64:
; SKIP-NOT: Skipping VMP on protected_fabd_v4f16:
; SKIP-NOT: Skipping VMP on protected_fabd_v8f16:
; SKIP-NOT: Skipping VMP on protected_fabd_last_fullfp16:
; SKIP-NOT: Skipping VMP on protected_fabd_bounds_v4f32:

; VIRT: define <2 x float> @protected_fabd_v2f32({{.*}} #[[PROT:[0-9]+]] {
; VIRT: vmp.dispatch:
; VIRT: call <2 x float> @llvm.aarch64.neon.fabd.v2f32(
; VIRT: define <4 x float> @protected_fabd_v4f32({{.*}} #[[PROT]] {
; VIRT: vmp.dispatch:
; VIRT: define <2 x double> @protected_fabd_v2f64({{.*}} #[[PROT]] {
; VIRT: vmp.dispatch:
; VIRT: define <4 x half> @protected_fabd_v4f16({{.*}} #[[PROTH:[0-9]+]] {
; VIRT: vmp.dispatch:
; VIRT: call <4 x half> @llvm.aarch64.neon.fabd.v4f16(
; VIRT: define <8 x half> @protected_fabd_v8f16({{.*}} #[[PROTH]] {
; VIRT: vmp.dispatch:
; VIRT: define <4 x half> @protected_fabd_last_fullfp16({{.*}} #[[PROTL:[0-9]+]] {
; VIRT: vmp.dispatch:
; VIRT: define <4 x float> @protected_fabd_bounds_v4f32({{.*}} #[[PROT]] {
; VIRT: vmp.dispatch:
; VIRT: call <4 x float> @llvm.aarch64.neon.fabd.v4f32(
